...
def generateCode():
    ...
    messagebox.showinfo("GoodSoldier1P1_7 QR Code Generator", "QR Code is saved successfully!")
    
    
# Creating the window
wn = Tk()
wn.title('GoodSolier1P1_7 QR Code Generator')
wn.geometry('700x700')
wn.config(bg='SteelBlue3')

# Label for the window
headingFrame = Frame(wn, bg="azure", bd=5)
headingFrame.place(relx=0.05, rely=0.05, relwidth=0.7, relheight=0.1)
headingLabel = Label(headingFrame, text="Generate QR Code with GoodSoldier1P1_7", bg="azure", font=('Times', 20, 'bold'))
...
text.place(relx=0.05, rely=0.35, relwidth=1, relheight=0.2)
...
loc = Entry(Frame2, font=('Centruy 12'))
...
label4 = Label(Frame4, text="Enter the size from 1 to 40 with the 1 being 21x21: ", bg="SteelBlue3", fg='azure', font=('Courier', 13, 'bold'))
